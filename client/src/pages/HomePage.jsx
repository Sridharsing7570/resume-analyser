...
const API_URL = import.meta.env.VITE_API_URL || "https://resume-analyser-beta.vercel.app";
        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            <div className="text-center mb-10">
                ...
                <p className="text-lg text-gray-600">
                    Upload your resume and get AI-powered career path suggestions based on your
            ...
            {analysis && (
                <div className="mt-10 bg-white p-8 rounded-lg shadow-md">
                    ...
                    <div className="mb-6">
                        <h3 className="text-xl font-semibold mb-2">Recommended Career Paths</h3>
